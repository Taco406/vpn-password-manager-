...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            vpn::vpn_persistent_deploy,
            vpn::vpn_persistent_connect,
            vpn::vpn_persistent_destroy,
            ...
            servers::servers_list_snapshots,
            servers::servers_events,
            ...
            crowdsec::crowdsec_scenarios,
            crowdsec::crowdsec_promote,
            crowdsec::crowdsec_demote,
            crowdsec::crowdsec_allowlist_get,
            crowdsec::crowdsec_allowlist_set,
            crowdsec::crowdsec_protected_list,
            crowdsec::crowdsec_fleet_sync,
            crowdsec::crowdsec_fleet_ban,
            crowdsec::crowdsec_fleet_unban,
